...
class WC_Subscriptions_Switcher {
	...
	public static function is_purchasable( $is_purchasable, $product ) {
		...
		if ( false === $is_purchasable && WC_Subscriptions_Product::is_subscription( $product->id ) && 'yes' === $product->limit_subscriptions && WC_Subscriptions_Manager::user_has_subscription( 0, $product->id ) ) {
