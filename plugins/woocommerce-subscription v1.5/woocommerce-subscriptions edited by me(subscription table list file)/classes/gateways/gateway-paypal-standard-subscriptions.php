...
<div id="message" class="updated warning">
	<p>
		<?php 
		printf( __( 'Just a few more steps to configure PayPal to sell subscriptions. Please %sset up the PayPal IPN%s and %senter your API credentials%s so that you can suspend and cancel subscriptions.', 'woocommerce-subscriptions' ),
