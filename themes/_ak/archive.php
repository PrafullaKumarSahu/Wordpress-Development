		...
		<div class="qua_page_heading">
				<h1 class="page-title">
					<?php
						...
						elseif ( is_day() ) :
							printf( __( 'Daily Archives: %s', '_tk' ), '<span>' . get_the_date() . '</span>' );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', '_tk' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', '_tk' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
